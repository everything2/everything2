...
const AcceptableUsePolicy = () => {
  return (
    <div className="document aup">

      <section className="aup__section">
        <p>By using this website, you implicitly agree to the following conditions:</p>

        <ol className="aup__list">
          <li className="aup__list-item">
            ...
            <p className="aup__harassment-intro">"Harassment" is defined as:</p>
            <ul className="aup__harassment-list">
