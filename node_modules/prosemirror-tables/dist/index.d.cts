import { EditorState, Transaction, PluginKey, Selection, Plugin, Command } from 'prosemirror-state';
import { Slice, Node, Attrs, ResolvedPos, NodeType, Fragment, NodeSpec, Schema } from 'prosemirror-model';
