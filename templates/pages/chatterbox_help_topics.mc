...
<p>The chatterbox help topics are a good way for new users to learn some of the basics of E2.  Simply type "/help TOPIC" in the chatterbox to get an automated message from <& '/helpers/linknode.mi', node => $.helpuser &> about that topic.  Best results will be achieved by searching in lowercase and multi-word topics should use underscores rather_than_spaces.  If you notice errors, or think additional topics should be available, contact an editor.</p>
