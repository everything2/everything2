...
sub _skippable_types
{
	return {
		...
		"edevdoc" => [],
		"patch" => [],
		"user" => [113,952215,779713,839239,1080927,373682,176726,373682,373113,1988327], #root,klaproth,guest user,cool man eddie,virgil,everyone,webster 1913,everyone, EDB, Fiery Teddy Bear
