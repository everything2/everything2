...
sub _skippable_types
{
	return {
		...
		"usergroup" => [838015, 114, 829913, 923653, 1199641, 1969185, 1192564, 1882128, 1175790, 1433518, 2175734, 1713398, 1797556, 1957798], #Edev, gods, e2gods, content editors, clientdev, chanops,debuggers,e2docs,%%, SIGTITLE, News, Sheriffs, thepub, podpeople
		"node_forward" => [],
		"ticket" => [], 
		"draft" => [],
		"podcast" => [],
