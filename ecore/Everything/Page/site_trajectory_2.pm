package Everything::Page::site_trajectory_2;

use Moose;
extends 'Everything::Page';

=head1 Everything::Page::site_trajectory_2

React page for Site Trajectory 2 - historical site statistics.

Displays monthly statistics for new writeups, contributing users, and C!s spent
with interactive visualization and configurable date range.
