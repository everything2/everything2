...
# doChatMacro htmlcode REMOVED - orphaned legacy chat-macro executor. Its only caller was the
# retired message opcode, and it held the last Everything::Delegation::opcode->can() reference.
# Modern /macro uses chatmacro_* VARS in processMessageCommand. #4335. Jun 2026.
