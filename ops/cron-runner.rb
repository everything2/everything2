...
pp ecsclient.run_task(cluster: "E2-App-ECS-Cluster", task_definition: "e2cron-family", launch_type: "FARGATE", overrides: {container_overrides: [{name: "e2app", command: ["/var/everything/cron/#{job}.pl"]}]}, network_configuration: {awsvpc_configuration: {subnets: [subnet_placement], security_groups: [security_group], assign_public_ip: "ENABLED"}})
