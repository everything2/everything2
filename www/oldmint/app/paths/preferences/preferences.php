...
<div id="container">
	...
	<div id="preferences">
		...
		<form method="post" action="<?php echo $Mint->cfg['installDir'];?>/<?php echo (isset($_GET['errors'])) ? '?errors' : ''?>">
			...
			<div class="footer">
				<div><input type="image" src="styles/<?php echo $Mint->cfg['preferences']['style']; ?>/images/btn-done.png" alt="Done" class="btn" /></div>
			</div>
		</form>
	</div>
